...
## 15/01/2026
Simple MP4 parser to pull frames out of a container file as well as a sample application demonstrating loading HAP and MJPEG frames out and rendering them.
...
This is a far from exhaustive implementation, only the atoms I needed to get the demo working have been implemented, but it's trivial to add new ones as they become available
